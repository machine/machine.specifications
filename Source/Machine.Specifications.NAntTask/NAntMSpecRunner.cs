...
using Machine.Specifications.ConsoleRunner;
...
namespace Machine.Specifications.NAntTask
{
    ...
    public class NAntMSpecRunnerTask : Task
    {
        ...
        protected override void ExecuteTask()
        {
            ...
            if (Project.Properties.Contains("teamcity.version"))
            {
                mainListener = new TeamCityReporter(x => Log(Level.Verbose, x), timingListener);
            }
            else
            {
