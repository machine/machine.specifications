...
copy /y Machine.Specifications.ReSharper.Runner.8.2.pdb "%APPDATA%\JetBrains\ReSharper\v8.2\Plugins\mspec" > NUL
copy /y Machine.Specifications.ReSharper.Provider.8.2.dll "%APPDATA%\JetBrains\ReSharper\v8.2\Plugins\mspec"
copy /y Machine.Specifications.ReSharper.Provider.8.2.pdb "%APPDATA%\JetBrains\ReSharper\v8.2\Plugins\mspec" > NUL
