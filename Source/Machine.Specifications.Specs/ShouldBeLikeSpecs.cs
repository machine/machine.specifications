...
@""""":
  ...
  But was:  2");
    ...
    public class when_asserting_object_is_like_expected_nested_object
    {
        ...
        public class with_correct_values
        {
            Because of = () => { Exception = Catch.Exception(() => _obj.ShouldBeLike(
                new{Prop1 = "value1", Prop2 = 10, NestedProp = new{NestedProp1 = 5, NestedProp2 = "value2"}})); };
        ...
        {
            Because of = () => { Exception = Catch.Exception(() => _obj.ShouldBeLike(
                new{Prop1 = "value1", Prop2 = 10, NestedProp = new{NestedProp1 = 7, NestedProp2 = "value2"}})); };
            
      It should_throw = () => Exception.ShouldBeOfType<SpecificationException>();
      It should_contain_message = () => Exception.Message.ShouldEqual(
@"""NestedProp.NestedProp1"":
  Expected: [7]
  But was:  [5]");
        }
        ...
        {
            Because of = () => { Exception = Catch.Exception(() => _obj.ShouldBeLike(
                new{Prop1 = "value1", Prop2 = 10, NestedProp = new{NestedProp1 = 5, NestedProp2 = "value2", NestedProp3 = "value3"}})); };
            
      It should_throw = () => Exception.ShouldBeOfType<SpecificationException>();
      It should_contain_message = () => Exception.Message.ShouldEqual(
@"""NestedProp.NestedProp3"":
  Expected: ""value3""
  But was:  Not Defined");
        }
    }
