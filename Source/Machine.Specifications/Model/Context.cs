...
namespace Machine.Specifications.Model
{
    public class Context
    {
        ...
        public Context(Type type, object instance, IEnumerable<Establish> contextClauses,
                       IEnumerable<Because> becauseClauses, IEnumerable<Cleanup> cleanupClauses, Subject subject,
                       bool isIgnored, IEnumerable<Tag> tags, bool isSetupForEachSpec)
        {
