...
namespace Machine.Specifications.Factories
{
    public class ContextFactory
    {
        ...
        static void CollectDetailsOf<T>(Type target, Func<object> instance_resolver, List<T> items)
        {
            if (target == typeof(Object) || target == null) return;
            var instance = instance_resolver();
