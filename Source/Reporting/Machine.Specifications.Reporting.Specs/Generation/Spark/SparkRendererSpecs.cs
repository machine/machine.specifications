              ...
              Report = Run(Assembly("assembly 2",
                                    Concern("a 2 concern 2",
                                            Context("a 2 c 2 context 2",
                                                    Spec("it", "a 2 c 2 c 2 specification 2", Runner.Utility.Result.Pass()),
                                                    Spec("it", "a 2 c 2 c 2 specification 1", Runner.Utility.Result.Ignored())
                                              ),
                                            Context("a 2 c 2 context 1",
                                                    Spec("it", "a 2 c 2 c 1 specification 2",
                                                         Runner.Utility.Result.Failure(PrepareException())),
                                                    Spec("it", "a 2 c 2 c 1 specification 1", Runner.Utility.Result.NotImplemented())
                                              )
                                      ),
                                    Concern("a 2 concern 1",
                                            Context("a 2 c 1 context 2",
                                                    ...
                                                    Spec("it", "a 2 c 1 c 2 specification 1", Runner.Utility.Result.Pass())
                                              ),
                           ...
                           Assembly("assembly 1",
                                    Concern("a 1 concern 2",
                                            Context("a 1 c 2 context 2",
                                                    Spec("it", "a 1 c 2 c 2 specification 2", Runner.Utility.Result.NotImplemented()),
                                                    Spec("it", "a 1 c 2 c 2 specification 1", Runner.Utility.Result.Pass())
                                              ),
                                            Context("a 1 c 2 context 1",
                                                    Spec("it", "a 1 c 2 c 1 specification 2", Runner.Utility.Result.Pass()),
                                    ...
                                    Concern("a 1 concern 1",
                                            Context("a 1 c 1 context 2",
                                                    Spec("it", "a 1 c 1 c 2 specification 2", Runner.Utility.Result.Pass()),
                                                    Spec("it", "a 1 c 1 c 2 specification 1", Runner.Utility.Result.NotImplemented())
                                              ),
                                            Context("a 1 c 1 context 1",
                                                    Spec("it", "a 1 c 1 c 1 specification 2", Runner.Utility.Result.Pass()),
                                                    Spec("it", "a 1 c 1 c 1 specification 1", Runner.Utility.Result.Pass())
                                              )
                                      )
                             )
                );
