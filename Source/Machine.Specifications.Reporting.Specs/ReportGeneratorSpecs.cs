...
namespace Machine.Specifications.Reporting.Specs
{
  ...
  public class when_rendering_the_HTML_report : ReportGeneratorSpecs
  {
    ...
    It should_order_the_assembly_concerns_by_name =
      () =>
        {
          var assemblyConcern1 = Html.IndexOf("<h2 class=\"concern\">" + RunResult.AssemblyName(1));
          var assemblyConcern2 = Html.IndexOf("<h2 class=\"concern\">" + RunResult.AssemblyName(2));
    ...
    It should_order_the_concerns_inside_an_assembly_by_name =
      () =>
        {
          var concern1 = Html.IndexOf("<h2 class=\"concern\">" + RunResult.AssemblyName(1) + RunResult.ConcernName(1));
          var concern2 = Html.IndexOf("<h2 class=\"concern\">" + RunResult.AssemblyName(1) + RunResult.ConcernName(2));
    ...
    It should_order_the_contexts_inside_a_concern_by_name =
      () =>
        {
          var context1 =
            Html.IndexOf("<h3 class=\"context\">" + RunResult.AssemblyName(1) + RunResult.ConcernName(1) +
    ...
    It should_order_the_specifications_inside_a_context_by_name =
      () =>
        {
          var spec1 = Html.IndexOf("<li>" + RunResult.AssemblyName(1) + RunResult.ConcernName(1) + RunResult.ContextName(1) + RunResult.SpecificationName(1));
          var spec2 = Html.IndexOf("<li>" + RunResult.AssemblyName(1) + RunResult.ConcernName(1) + RunResult.ContextName(1) + RunResult.SpecificationName(2));
