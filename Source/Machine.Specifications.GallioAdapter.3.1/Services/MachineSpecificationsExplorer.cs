...
namespace Machine.Specifications.GallioAdapter.Services
{
    public class MachineSpecificationsExplorer : TestExplorer
    {
        ...
        private readonly Dictionary<IAssemblyInfo, MachineAssemblyTest> assemblyTests = 
        ...
        private MachineContextTest GetContextTest(Context context)
        {
        ...
        private MachineSpecificationTest GetSpecificationTest(Context context, Specification specification)
        {            
