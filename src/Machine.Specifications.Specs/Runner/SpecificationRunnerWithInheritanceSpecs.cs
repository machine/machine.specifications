namespace Machine.Specifications.Specs.Runner
{
    ...
    public class when_running_a_context_with_inherited_specifications : RunnerSpecs
    {
        Establish context = () =>
        {
    ...
    [Subject("Specification Runner")]
    public class when_running_a_context_with_inherited_specifications_and_setup_once_per_attribute : RunnerSpecs
    {
        Establish context = () =>
        {
            context_that_inherits.base_establish_run_count = 0;
