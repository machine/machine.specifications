...
namespace Machine.Specifications.Runner.Utility
{
    ...
    {
        Because of = () =>
          runner.RunAssembly(new AssemblyPath(typeof(cleanup_failure).Assembly.Location));
    ...
    {
        Because of = () =>
          runner.RunNamespace(new AssemblyPath(typeof(Account).Assembly.Location), "Example");
    ...
    {
        Because of = () =>
          runner.RunMember(new AssemblyPath(typeof(Account).Assembly.Location), typeof(when_transferring_an_amount_larger_than_the_balance_of_the_from_account).GetField("should_not_allow_the_transfer", BindingFlags.NonPublic | BindingFlags.Instance));
    ...
    {
        Because of = () =>
          runner.RunMember(new AssemblyPath(typeof(Container).Assembly.Location), typeof(Container.nested_context));
    ...
    {
        Because of = () =>
          runner.RunMember(new AssemblyPath(typeof(Container).Assembly.Location), typeof(Container.nested_context).GetField("should_be_run", BindingFlags.NonPublic | BindingFlags.Instance));
