...
var solution = File("./Machine.Specifications.Runner.Console.sln");
    ...
    .Does(() => 
{
    ...
    MSBuild(solution, x => x
        .SetConfiguration(configuration)
        .WithProperty("Version", version)
        .WithProperty("AssemblyVersion", versionNumber)
        .WithProperty("FileVersion", versionNumber)
    );
});
